...
async function parseArgs() {
	...
	if (!inputPath) {
		console.error(
			'No input provided. Place a brand icon in static/brand/app-icon.(png|webp|jpg) or pass a path.'
		);
...
async function generate() {
	...
	const fullBleed =
		base.includes('app-icon') || base.includes('apple-touch-icon') || base.includes('favicon');
