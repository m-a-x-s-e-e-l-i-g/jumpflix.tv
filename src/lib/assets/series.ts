...
export const series = [
	...
	// },
	{
		...
		description:
			"A short documentary series exploring what parkour means to practitioners and the so-called 'parkour vision'.",
		thumbnail: '/images/posters/parkour-the-nature-of-challenge-poster.webp',
		type: 'series',
		seasons: [{ seasonNumber: 1, playlistId: 'PLFE063C4ADA6CAA18' }],
		videoCount: 4,
		starring: []
	},
	// {
	...
	// },
	{
		...
		description:
			'A four-part Spanish parkour series (2013–2015) featuring MADD, BTT GUP, James Kingston and others.',
		thumbnail: '/images/posters/gravity-series-spanish-parkour-poster.webp',
		type: 'series',
		seasons: [{ seasonNumber: 1, playlistId: 'PLQLQeBBGuzK93e_bI1nt7j5Hkb92Nzgre' }],
		videoCount: 4,
		starring: [
			'MADD',
			'BTT',
	...
	},
	{
		...
		description:
			'A Swedish winter parkour trilogy shot in undercover and underground spots across Stockholm and the south (Lund, Helsingborg, Malmö), turning rough, unlikely locations into creative lines. DIY-filmed with a colorful, psychedelic, EDM-tinged vibe, it shows how the crew keeps moving through long, dark, wet winters.',
		thumbnail: '/images/posters/kipa-udg-poster-underground-parkour-freerun.webp',
		type: 'series',
		seasons: [{ seasonNumber: 1, playlistId: 'PL5_AeU_YPHqX5CfDpxWbogjIGBn_JtdTc' }],
		videoCount: 3,
	...
	},
	{
		...
		description:
			'A series of short films by Manor pushing the visual language of parkour. Highlighting movement with intention — focusing on athletes and ideas that deserve more attention.',
		thumbnail: '/images/posters/manor-dear-series-poster.webp',
		type: 'series',
		seasons: [{ seasonNumber: 1, playlistId: 'PL3iwaCsp8s8Ps6L4CyXP9gKcCh4jKiT-U' }],
		videoCount: 4,
