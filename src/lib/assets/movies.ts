...
export const movies = [
	{
		...
		year: '2003',
		description:
			'The documentary that introduced parkour to the world, featuring Sébastien Foucan and other founding traceurs.',
		thumbnail: '/images/posters/jump-london-poster.webp',
		videoId: 'l8fSXGP9wvQ',
		type: 'movie',
		duration: '60m',
	...
	},
	{
		...
		year: '2005',
		description:
			'The follow-up to Jump London, showcasing British traceurs and the growth of parkour in the UK.',
		thumbnail: '/images/posters/jump-britain-poster.webp',
		videoId: '2TJurAP9l-Q',
		type: 'movie',
		duration: '60m',
	...
	},
	{
		...
		year: '2020',
		description:
			'The Motus Projects athletes push their physical and mental limits in this raw documentary about the evolving sport of parkour. Through elation, stress, injury and laughter, their friendship drives their success.',
		thumbnail: '/images/posters/sole-destroyer-poster.webp',
		videoId: 'VlM7bOegiIg',
		type: 'movie',
		duration: '40m',
	...
	},
	{
		...
		year: '2024',
		description:
			"AMSTERDAM IS DEAD a Parkour Film aiming to revive this city's lost street parkour scene. Documentaire door Fé Amsterdam.",
		thumbnail: '/images/posters/amsterdam-is-dead-poster.webp',
		videoId: 'lJX3DUlSj4M',
		type: 'movie',
		duration: '48m',
	...
	},
	{
		...
		year: '2017',
		description:
			'Team Storror push Parkour to the rooftops of Asian megacities, filming guerilla-style while exploring the drive, struggles, and preparation behind making impossible "leaps of faith" possible.',
		thumbnail: '/images/posters/roof-culture-asia-poster.webp',
	...
	},
	{
		...
		year: '2022',
		description:
			'S.O.L is a parkour tour film with the carefree vibe of 2010s summer edits, focusing less on moves and more on friendship, support, and shared training moments.',
	...
	},
	{
		...
		thumbnail: '/images/posters/people-in-motion-poster.webp',
		videoId: 'QH09YCtpKaw',
		type: 'movie',
		duration: '55m',
	...
	},
	{
		...
		thumbnail: '/images/posters/my-playground-poster.webp',
		videoId: 'BX-KFdI4LG8',
		type: 'movie',
		duration: '52m',
	...
	},
	{
		...
		year: '2008',
		description:
			'A documentary following his journey to and around Lisses, the birthplace of Parkour. It contains footage of 150+ traceurs, and was shown to David Belle for approval before release.',
	...
	},
	{
		...
		year: '2015',
		description:
			'Seven parkour athletes roam Southeast Asia for 28 days with no plans, money, or accommodation—capturing a feature-length adventure about freedom and pushing limits.',
		thumbnail: '/images/posters/storror-supertramps-thailand-poster.webp',
	...
	},
	{
		...
		year: '2024',
		description:
			'“Gatecrashers” is an all-women Parkour action film following 8 athletes across three European cities. It celebrates female Parkour at its highest level—pushing limits, exploring, and inspiring anyone who loves to move or wants to start.',
		thumbnail: '/images/posters/gatecrasher-an-all-women-s-parkour-action-film-poster.webp',
		videoId: '4izoWYFmNg0',
		type: 'movie',
		duration: '38m',
	...
	},
	{
		...
		year: '2023',
		description:
			'In August 2021, eight elite women gathered in Denver to train and film parkour, creating a project that reflects their vision of the city and passion for movement.',
	...
	},
	{
		...
		year: '2017',
		description:
			'A poetic documentary following urban athletes as they practice parkour, jumping from roof to roof through the city. Filmmaker Juriën Cornelissen captures the physical experience and adventure in this graduation film.',
		thumbnail: '/images/posters/balancing-organisms-convoi-films-parkour-poster.webp',
		vimeoId: '223802198',
		type: 'movie',
		duration: '28m',
		creators: ['Juriën Cornelissen', 'Convoi Films'],
		starring: ['Luciano Balestra', 'Phil Doyle']
	},
	{
		id: 14,
		...
		year: '2006',
		description:
			'Dive into the Art of Displacement! Yamakasi transform Paris’s suburbs into playgrounds, inspiring youth with discipline and will. As it becomes an extreme sport, will its social message survive?',
		thumbnail: '/images/posters/generation-yamakasi-poster.webp',
		videoId: '0GyxTe9W_yI',
		type: 'movie',
		duration: '1h 11m',
	...
	},
	{
		...
		thumbnail: '/images/posters/district-b13-poster.webp',
		type: 'movie',
		duration: '1h 24m',
	...
	},
	{
		...
		thumbnail: '/images/posters/district-13-ultimatum-poster.webp',
		type: 'movie',
		duration: '1h 41m',
	...
	},
	{
		...
		year: '2015',
		description:
			'A NYC bike messenger, hunted by the mob, dives into an underground parkour crew that offers a risky way out.',
		thumbnail: '/images/posters/tracers-poster.webp',
		type: 'movie',
		duration: '1h 34m',
	...
	},
	{
		...
		year: '2014',
		description:
			'An undercover cop and an ex-con with parkour skills team up to stop a crime lord’s bomb plot in walled-off Detroit.',
		thumbnail: '/images/posters/brick-mansions-poster.webp',
		type: 'movie',
		duration: '1h 30m',
	...
	},
	{
		...
		year: '2019',
		description:
			'A dead-on-paper billionaire forms a covert parkour-savvy vigilante squad to topple a brutal dictator.',
		thumbnail: '/images/posters/6-underground-poster.webp',
		type: 'movie',
		duration: '2h 8m',
	...
	},
	{
		...
		year: '2011',
		description:
			'With an explosive collar ticking down, a freerunner sprints across the city battling rivals to save himself and his girlfriend.',
		thumbnail: '/images/posters/freerunner-poster.webp',
		type: 'movie',
		duration: '1h 27m',
	...
	},
	{
		...
		year: '2015',
		description:
			'Road trip documentary following Jesse La Flair and Cory DeMeyers chasing their freerunning ambitions across the US.',
		thumbnail: '/images/posters/from-here-to-there-poster.webp',
		type: 'movie',
		duration: '1h',
	...
	},
	{
		...
		year: '2019',
		description:
			'“Bound by Movement” follows top parkour athletes on a 63-day U.S. tour, risking injury and arrest to film daring flips and tricks in iconic spots and abandoned buildings, revealing the drive that unites them until things inevitably go wrong.',
		thumbnail: '/images/posters/bound-by-movement-poster.webp',
		type: 'movie',
		duration: '1h 22m',
		trakt: 'https://trakt.tv/movies/bound-by-movement-2019',
		videoId: 'o3-B5EH0mDE',
		creators: ['Jesse La Flair'],
		starring: ['Jesse La Flair', 'Sydney Olson', 'Corbin Reinhardt']
	},
	{
		id: 23,
		...
		year: '2022',
		description:
			'Showcase of UK parkour talent pushing creative and powerful new directions following the original Capstone project.',
		thumbnail: '/images/posters/capstone-the-england-project-poster.webp',
		videoId: 'fv4lg1TfKIA',
		type: 'movie',
		duration: '17m',
	...
	},
	{
		...
		year: '2013',
		description:
			'A street-smart 17-year-old parkour thief faces a dangerous past while trying to protect his family.',
		thumbnail: '/images/posters/run-poster.webp',
		type: 'movie',
		duration: '1h 46m',
	...
	},
	{
		...
		year: '2017',
		description:
			"MYRM's documentary style film featuring the views and moves of several influential parkour practitioners.",
	...
	},
	{
		...
		year: '2021',
		description:
			'Months of filming have been put together in the hopes of capturing the Swedish parkour scene and the general vibe we have whilst training.',
	...
	},
	{
		...
		year: '2023',
		description:
			'A documentary about living permanently switched ON. A mindset where fear fades and passion takes over—driving you to create, move, and push limits every day.',
	...
	},
	{
		...
		year: '2023',
		description:
			"Grassroots GEFAM-funded parkour film inspired by Capst1, spotlighting the creative flip side of movement. Filmed in Frankfurt, the name stuck after an inside joke about the city's rough edges—capturing a raw, collaborative energy the crew hopes to build on.",
	...
	},
	{
		...
		year: '2022',
		description:
			'Hazel marks Ethan Rud’s 10 years of parkour, channeling grief after a mentor’s loss. Filmed in Minneapolis and Los Angeles by Noah Heath, it’s a dark, moody street video paving the way for shorter pay-per-view films.',
	...
	},
	{
		...
		year: '2023',
		description:
			'This film is very fine! It shows the beauty of parkour in Thailand, combining stunning locations with smooth movement and a chilled vibe.',
	...
	},
	{
		...
		year: '2023',
		description:
			"Commit's documentary about the power of a community. Highlighting the parkour community in Eindhoven, by showing the stories of their team members.",
	...
	},
	{
		...
		year: '2023',
		description:
			'Displaying a great part of the versatile Munich PK scene, with 19 athletes ticking off their most fearful challenges!',
	...
	},
	{
		...
		year: '2024',
		description:
			'Matt McCreary and Kevin Franzén present "Fishboy & Dr.Eel". A summer of wild ideas, unique spots, big laughs, and an unforgettable ender filmed in Hamburg and Brighton.',
	...
	},
	{
		...
		year: '2024',
		description:
			'Parkour feels like a foreign exchange programme. Ideas get shared around with the migration of people between places. FOREIGN EXCHANGE features 22 athletes from 9 different countries.',
	...
	},
	{
		...
		year: '2023',
		description:
			"Norf is a team from Minneapolis, Minnesota. Advocating for quality over quantity and long-form content over Instagram clips they made 'Lullaby' to capture their unique movement style and passion for the sport.",
	...
	},
	{
		...
		year: '2023',
		description:
			'A parkour film on healing and identity, moving from injury and solitude to friendship and freedom through body, space, and people.',
	...
	},
	{
		...
		year: '2023',
		description:
			'A Berlin Parkour Film made By five young athletes, with the goal to represent Berlin in the global Parkour World and get the name of the team out there. First of many projects, the style is very street orientated and true to the culture.',
	...
	},
	{
		...
		year: '2024',
		description:
			'A Documentary and of Parkour and the culture in LaPaz - Bolivia. Shot on a three month trip.',
	...
	},
	{
		...
		year: '2009',
		description:
			'A parkour video by Latvian freerunner Oleg Vorslav, also known for the early “Russian Climbing” videos. It became one of the first viral parkour videos and is remembered as a community classic.',
	...
	},
	{
		...
		year: '2020',
		description:
			"The Swedish parkour scene captured over a couple of summer months – with extra clips from Kevin's time in Germany. Named after Pontus Karlsson's Citroën Berlingo, the car that carried the crew across Sweden while filming this vibe-heavy tour film.",
		thumbnail: '/images/posters/berlingo-kipa-swedish-parkour-film-poster.webp',
		videoId: 'xB3UKv6hFoc',
		type: 'movie',
		duration: '27m',
		creators: ['KIPA', 'Lester Castro'],
		starring: ['Joel Larsson', 'Hugo Arnesson', 'Kevin Franzén', 'Lester Castro', 'Måns']
	},
	{
		id: 42,
		title: 'FULL OF LIFE',
		year: '2023',
		description:
			"A 12 day trip to Lisbon in December 2022. Despite heavy rain and flooding, the crew explored the city's iconic beige limestone spots daily—12 days, full of life!",
	...
	},
	{
		...
		year: '2023',
		description:
			"A week-long KIPA project capturing Berlin's rich parkour heritage—its history, raw architecture and unique spots—shot non-stop to inspire more athletes to come explore the city.",
		thumbnail: '/images/posters/kipa-berlin-parkour-film-poster.webp',
		videoId: 'S53OMhqzJZQ',
		type: 'movie',
		duration: '28m',
		creators: ['KIPA', 'Lester Castro Nilsson'],
