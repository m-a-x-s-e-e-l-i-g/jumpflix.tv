...
<DialogRoot bind:open>
	...
	<DialogContent class="max-h-[80vh] max-w-2xl overflow-y-auto">
		...
		<div class="space-y-4 text-sm">
			...
			{:else if locale === 'ja'}
				<div>
					<h3 class="font-semibold mb-2">1. 収集するデータ</h3>
					<p class="text-muted-foreground mb-2">JumpFlixでは、以下のデータを収集します：</p>
					<ul class="list-disc list-inside space-y-1 text-muted-foreground ml-2">
						<li><strong class="text-foreground">アカウント情報：</strong>メールアドレスとパスワード（暗号化）</li>
				...
				<div>
					<h3 class="font-semibold mb-2">2. データの使用方法</h3>
					<ul class="list-disc list-inside space-y-1 text-muted-foreground ml-2">
				...
				<div>
					<h3 class="font-semibold mb-2">3. マーケティングとコミュニケーション</h3>
					<p class="text-muted-foreground mb-2">アカウント作成時に、以下に関するニュースと更新情報の受信を選択できます：</p>
					<ul class="list-disc list-inside space-y-1 text-muted-foreground ml-2">
				...
				<div>
					<h3 class="font-semibold mb-2">4. データの共有</h3>
					<p class="text-muted-foreground mb-2">データを第三者に販売することはありません。以下のサービスとのみデータを共有します：</p>
					<ul class="list-disc list-inside space-y-1 text-muted-foreground ml-2">
						<li><strong class="text-foreground">Supabase：</strong>認証とデータベースホスティング用</li>
						<li><strong class="text-foreground">Vimeo/YouTube：</strong>動画再生用</li>
					</ul>
				</div>

				<div>
					<h3 class="font-semibold mb-2">5. あなたの権利</h3>
					<p class="text-muted-foreground mb-2">以下の権利があります：</p>
					<ul class="list-disc list-inside space-y-1 text-muted-foreground ml-2">
						<li>個人データへのアクセス</li>
						<li>データの修正</li>
						<li>データの削除</li>
				...
				<div>
					<h3 class="font-semibold mb-2">6. セキュリティ</h3>
					<p class="text-muted-foreground">
